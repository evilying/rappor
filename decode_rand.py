import pandas as pd
from rappor import ProcessDataAndParameters,mapBloomFilter1
import numpy as np
...
for cand in candidates[field]:
    ...
    for cohort in range(1,icohort+1):
        vec_cand = mapBloomFilter1(cand, cohort, nhashes, nbits)
        col.extend(vec_cand)
...
[matrix,cohorts] = ProcessDataAndParameters(client, icohort, f, nbits, nhashes, X)
#print(allunique)
